...
class Tarifa extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:
          AppBar(title: Text("Boletos "), backgroundColor: Color(0xffde1752)),
      drawer: DrawerMenu(),
      body: Center(
        child: Container(
          width: 300,
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                      ...
                      borderSide:
                          BorderSide(color: Color(0xffd02063), width: 2)),
                  enabledBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(11),
                      borderSide:
                          BorderSide(color: Color(0xff481274), width: 2)),
                  disabledBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(11),
                      borderSide:
                          BorderSide(color: Color(0xff6f0ea8), width: 2)),
                  prefixIcon: IconButton(
                    icon: Icon(
                      Icons.verified_user,
                      color: Color(0xffc3146b),
                    ),
                    onPressed: () {},
                  ),
                ),
